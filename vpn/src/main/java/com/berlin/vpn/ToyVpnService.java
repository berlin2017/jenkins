...
public class ToyVpnService extends VpnService implements Handler.Callback {
    ...
    private void updateForegroundNotification(final int message) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            startForeground(1, new NotificationCompat.Builder(this, createNotificationChannel("com.berlin.vpn", "vpnService"))
    ...
    private String createNotificationChannel(String channelId, String channleName) {

        NotificationChannel channel = new NotificationChannel(channelId, channleName, NotificationManager.IMPORTANCE_NONE);
